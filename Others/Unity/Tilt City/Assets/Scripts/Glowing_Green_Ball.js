...
green_cylinder_halo.animation.Play("Green Cylinder Halo Animation First Formation");
Play.score_int += 2;
...
green_cylinder_halo.animation.Play("Green Halo Animation Second Formation");
Play.score_int += 2;
Play.score.text = Play.score_int.ToString();
this.transform.position.y = -20;
GameObject.Find("Score Music").audio.Play();
...
green_cylinder_halo.animation.Play("Green Cylinder Halo Animation Fifth Formation");
Play.score_int += 2;
Play.score.text = Play.score_int.ToString();
this.transform.position.y = -20;
GameObject.Find("Score Music").audio.Play();
