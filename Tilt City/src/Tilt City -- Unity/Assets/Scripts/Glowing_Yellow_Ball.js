...
var glowing_yellow_ball_clone : GameObject;
glowing_yellow_ball_clone = GameObject.Find("Glowing Yellow Ball(Clone)");
...
yellow_cylinder_halo.animation.Play("Yellow Cylinder Halo Animation First Formation");
Play.score_int += 2;
Play.score.text = Play.score_int.ToString();
this.transform.position.y = -20;
GameObject.Find("Score Music").audio.Play();
}
}
...
yellow_cylinder_halo.animation.Play("Yellow Cylinder Halo Animation Third Formation");
Play.score_int += 2;
Play.score.text = Play.score_int.ToString();
this.transform.position.y = -20;
GameObject.Find("Score Music").audio.Play();
...
yellow_cylinder_halo.animation.Play("Yellow Cylinder Halo Animation Fifth Formation");
Play.score_int += 2;
Play.score.text = Play.score_int.ToString();
this.transform.position.y = -20;
GameObject.Find("Score Music").audio.Play();
