...
public static var tilt_sensitivity_slider_value : float;
tilt_sensitivity_slider_value = PlayerPrefs.GetFloat("tilt sensitivity", 0.3);
...
tilt_sensitivity_slider_value = GUI.HorizontalSlider(Rect(Screen.width/10, Screen.height/1.6, Screen.width/2, Screen.height/10), tilt_sensitivity_slider_value, 0.1, 0.7);

GUI.Label(Rect(Screen.width/10, Screen.height/1.9, 1000, 500), "Tilt Sensitivity");
...
Accelerometer_Rotate.tilt_sensitivity = tilt_sensitivity_slider_value;

PlayerPrefs.SetFloat("tilt sensitivity", tilt_sensitivity_slider_value);
