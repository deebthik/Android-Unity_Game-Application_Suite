...
blue_cylinder_halo.animation.Play();
Play.score_int += 1;
...
var distance_ball_clone2 = this.transform.position.y - big_cuboid.transform.position.y;
var distance_ball_clone2_2 = this.transform.position.y - small_cuboid_1.transform.position.y;
var distance_ball_clone2_3 = this.transform.position.y - small_cuboid_2.transform.position.y;


if(distance_ball_clone2 > 5){
